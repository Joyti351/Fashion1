...
<div class="container-fluid">
    ...
    <div class="col-md-12">
        ...
        <div class="card-header">
            <h3 class="card-title">Blog_data_table<small>for Blog_image</small></h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" action="{{ url('blog-store') }}" method="post" id="quickForm"
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="exampleInputPassword1">date_1</label>
                    <input type="text" name="date_1" class="form-control" id="exampleInputPassword1" >
                    <p class="text-danger"></p>
                </div>
                <div class="form- roup">
                ...
                <div class="form-group">
                    <label for="exampleInputPassword1">date_2</label>
                    <input type="text" name="date_2" class="form-control" id="exampleInputPassword1" >
                    <p class="text-danger"></p>
                </div>
                <div class="form- roup">
                ...
                <div class="form-group">
                    <label for="exampleInputPassword1">date_3</label>
                    <input type="text" name="date_3" class="form-control" id="exampleInputPassword1" >
                    <p class="text-danger"></p>
                </div>
